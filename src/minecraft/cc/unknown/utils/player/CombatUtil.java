...
public enum CombatUtil implements Loona {
	...
	public double getLookingTargetRange(EntityPlayerSP player, AxisAlignedBB bb) {
		return getLookingTargetRange(player, bb, 6.0);
	}

	public double getLookingTargetRange(EntityPlayerSP player, AxisAlignedBB bb, double range) {
	...
	public MovingObjectPosition rayCastedBlock(float yaw, float pitch) {
		...
		MovingObjectPosition ray = mc.world.rayTraceBlocks(vec3, vec32, false, false, false);
