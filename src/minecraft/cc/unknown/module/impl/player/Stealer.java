...
public class Stealer extends Module {
	...
	public void onPre(MotionEvent e) {
		if (e.isPre()) {
			if ((mc.currentScreen != null) && (mc.player.inventoryContainer != null)
					&& (mc.player.inventoryContainer instanceof ContainerPlayer)
	...
	private void clickSlot(int x) {
		mc.playerController.windowClick(mc.player.openContainer.windowId, x, 0, 1, mc.player);
	}
}