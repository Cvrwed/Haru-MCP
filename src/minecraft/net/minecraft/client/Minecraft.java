...
public class Minecraft implements IThreadListener, IPlayerUsage {
	...
	private void drawSplashScreen(TextureManager textureManagerInstance) throws LWJGLException {
		...
		worldrenderer.func_181662_b(0.0D, (double) this.displayHeight, 0.0D).func_181673_a(0.0D, 0.0D)
				.func_181669_b(255, 255, 255, 255).func_181675_d();
		worldrenderer.func_181662_b((double) this.displayWidth, (double) this.displayHeight, 0.0D)
				.func_181673_a(0.0D, 0.0D).func_181669_b(255, 255, 255, 255).func_181675_d();
		worldrenderer.func_181662_b((double) this.displayWidth, 0.0D, 0.0D).func_181673_a(0.0D, 0.0D)
				.func_181669_b(255, 255, 255, 255).func_181675_d();
		worldrenderer.func_181662_b(0.0D, 0.0D, 0.0D).func_181673_a(0.0D, 0.0D).func_181669_b(255, 255, 255, 255)
				.func_181675_d();
		tessellator.draw();
	...
	public void func_181536_a(int p_181536_1_, int p_181536_2_, int p_181536_3_, int p_181536_4_, int p_181536_5_,
		...
		worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
		worldrenderer.func_181662_b((double) p_181536_1_, (double) (p_181536_2_ + p_181536_6_), 0.0D)
				.func_181673_a((double) ((float) p_181536_3_ * f), (double) ((float) (p_181536_4_ + p_181536_6_) * f1))
				.func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
		worldrenderer.func_181662_b((double) (p_181536_1_ + p_181536_5_), (double) (p_181536_2_ + p_181536_6_), 0.0D)
				.func_181673_a((double) ((float) (p_181536_3_ + p_181536_5_) * f),
						(double) ((float) (p_181536_4_ + p_181536_6_) * f1))
				.func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
		worldrenderer.func_181662_b((double) (p_181536_1_ + p_181536_5_), (double) p_181536_2_, 0.0D)
				.func_181673_a((double) ((float) (p_181536_3_ + p_181536_5_) * f), (double) ((float) p_181536_4_ * f1))
				.func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
		worldrenderer.func_181662_b((double) p_181536_1_, (double) p_181536_2_, 0.0D)
	...
	public int getLimitFramerate() {
		return this.world == null && this.currentScreen != null ? 9000 : this.gameSettings.limitFramerate;
	}
	...
	private void displayDebugInfo(long elapsedTicksTime) {
		if (this.mcProfiler.profilingEnabled) {
			...
			worldrenderer
					.func_181662_b((double) ((float) j - (float) i * 1.1F),
							(double) ((float) k - (float) i * 0.6F - 16.0F), 0.0D)
					.func_181669_b(200, 0, 0, 0).func_181675_d();
			worldrenderer.func_181662_b((double) ((float) j - (float) i * 1.1F), (double) (k + i * 2), 0.0D)
					.func_181669_b(200, 0, 0, 0).func_181675_d();
			worldrenderer.func_181662_b((double) ((float) j + (float) i * 1.1F), (double) (k + i * 2), 0.0D)
					.func_181669_b(200, 0, 0, 0).func_181675_d();
			worldrenderer
			...
			for (int l = 0; l < list.size(); ++l) {
				...
				int l1 = j1 >> 8 & 255;
				int i2 = j1 & 255;
				worldrenderer.func_181662_b((double) j, (double) k, 0.0D).func_181669_b(k1, l1, i2, 255)
						.func_181675_d();
				...
				for (int j2 = i1; j2 >= 0; --j2) {
					...
					worldrenderer.func_181662_b((double) ((float) j + f1), (double) ((float) k - f2), 0.0D)
							.func_181669_b(k1, l1, i2, 255).func_181675_d();
				}
				...
				for (int i3 = i1; i3 >= 0; --i3) {
					...
					worldrenderer.func_181662_b((double) ((float) j + f4), (double) ((float) k - f5), 0.0D)
							.func_181669_b(k1 >> 1, l1 >> 1, i2 >> 1, 255).func_181675_d();
					worldrenderer.func_181662_b((double) ((float) j + f4), (double) ((float) k - f5 + 10.0F), 0.0D)
							.func_181669_b(k1 >> 1, l1 >> 1, i2 >> 1, 255).func_181675_d();
				}
	...
	public void rightClickMouse() {
		if (!this.playerController.func_181040_m()) {
			...
			if (this.objectMouseOver == null) {
				...
				switch (this.objectMouseOver.typeOfHit) {
				case ENTITY:
					if (this.playerController.func_178894_a(this.player, this.objectMouseOver.entityHit,
