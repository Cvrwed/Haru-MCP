...
public class ItemRenderer {
	 ...
	 * person.
	 * 
	 * @param equipProgress The progress of the animation to equip (raise from out
	...
	private void renderWaterOverlayTexture(float p_78448_1_) {
		if (!Config.isShaders() || Shaders.isUnderwaterOverlay()) {
			...
			worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
			worldrenderer.func_181662_b(-1.0D, -1.0D, -0.5D).func_181673_a((double) (4.0F + f7), (double) (4.0F + f8))
					.func_181675_d();
			worldrenderer.func_181662_b(1.0D, -1.0D, -0.5D).func_181673_a((double) (0.0F + f7), (double) (4.0F + f8))
					.func_181675_d();
			worldrenderer.func_181662_b(1.0D, 1.0D, -0.5D).func_181673_a((double) (0.0F + f7), (double) (0.0F + f8))
					.func_181675_d();
			worldrenderer.func_181662_b(-1.0D, 1.0D, -0.5D).func_181673_a((double) (4.0F + f7), (double) (0.0F + f8))
					.func_181675_d();
			tessellator.draw();
			GlStateManager.popMatrix();
			GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
	...
	private void renderFireInFirstPerson(float p_78442_1_) {
		...
		if (p_78442_1_ != 1F && fb.isEnabled()) {
			GlStateManager.color(1.0F, 1.0F, 1.0F, fb.fire.getInputToFloat());
		} else {
		...
		for (int i = 0; i < 2; ++i) {
			...
			worldrenderer.func_181662_b((double) f5, (double) f7, (double) f9).func_181673_a((double) f2, (double) f4)
					.func_181675_d();
			worldrenderer.func_181662_b((double) f6, (double) f7, (double) f9).func_181673_a((double) f1, (double) f4)
					.func_181675_d();
			worldrenderer.func_181662_b((double) f6, (double) f8, (double) f9).func_181673_a((double) f1, (double) f3)
					.func_181675_d();
			worldrenderer.func_181662_b((double) f5, (double) f8, (double) f9).func_181673_a((double) f2, (double) f3)
					.func_181675_d();
			tessellator.draw();
			GlStateManager.popMatrix();
		}
