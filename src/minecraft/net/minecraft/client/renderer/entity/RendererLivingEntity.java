			...
			if (this.canRenderName(entity)) {
				...
				if (d0 < (double) (f * f)) {
					...
					if (entity.isSneaking()) {
						...
						worldrenderer.func_181662_b((double) (-i - 1), -1.0D, 0.0D)
								.func_181666_a(0.0F, 0.0F, 0.0F, 0.25F).func_181675_d();
						worldrenderer.func_181662_b((double) (-i - 1), 8.0D, 0.0D)
								.func_181666_a(0.0F, 0.0F, 0.0F, 0.25F).func_181675_d();
						worldrenderer.func_181662_b((double) (i + 1), 8.0D, 0.0D).func_181666_a(0.0F, 0.0F, 0.0F, 0.25F)
								.func_181675_d();
						worldrenderer.func_181662_b((double) (i + 1), -1.0D, 0.0D)
								.func_181666_a(0.0F, 0.0F, 0.0F, 0.25F).func_181675_d();
						tessellator.draw();
