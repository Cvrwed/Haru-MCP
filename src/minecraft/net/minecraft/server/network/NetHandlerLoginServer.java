...
public class NetHandlerLoginServer implements INetHandlerLoginServer, ITickable {
	...
	public void closeConnection(String reason) {
		try {
			...
			Haru.instance.getEventBus().post(new DisconnectionEvent(Side.Server));
		...
		if (s != null) {
			...
			if (this.server.getNetworkCompressionTreshold() >= 0 && !this.networkManager.isLocalChannel()) {
				this.networkManager.sendPacket(
						new SPacketEnableCompression(this.server.getNetworkCompressionTreshold()),
	...
	public void processLoginStart(CPacketLoginStart packetIn) {
		...
		if (this.server.isServerInOnlineMode() && !this.networkManager.isLocalChannel()) {
			...
			this.networkManager.sendPacket(new SPacketEncryptionRequest(this.serverId,
