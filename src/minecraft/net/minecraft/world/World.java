...
public abstract class World implements IBlockAccess {
	 ...
	 * 
	 * @param flags Flag 1 will cause a block update. Flag 2 will send the change to
	 *              clients (you almost always want this). Flag 4 prevents the block
	 *              from being re-rendered, if this is a client world. Flags can be
	 *              added together.
	 */
	 ...
	 * @param noWaterAdj If true, this method will only return true if there is a
	 ...
	 * 
	 * @param pos        The block coordinates
	 * @param checkLight If false, checking for the correct light values will be
	 *                   skipped
	 */
	...
	public int getRedstonePower(BlockPos pos, EnumFacing facing) {
		IBlockState iblockstate = this.getBlockState(pos);
		Block block = iblockstate.getBlock();
		return block.isNormalCube() ? this.getStrongPower(pos)
