...
public class SPacketPlayerListItem implements Packet<INetHandlerPlayClient>
{
    ...
    public SPacketPlayerListItem(SPacketPlayerListItem.Action actionIn, EntityPlayerMP... players)
    {
    ...
    public SPacketPlayerListItem(SPacketPlayerListItem.Action actionIn, Iterable<EntityPlayerMP> players)
    {
        this.action = actionIn;
    ...
    public void readPacketData(PacketBuffer buf) throws IOException
    {
        ...
        for (int j = 0; j < i; ++j)
        {
            ...
            this.players.add(new SPacketPlayerListItem.AddPlayerData(gameprofile, k, worldsettings$gametype, ichatcomponent));
        }
    }
    ...
    public void writePacketData(PacketBuffer buf) throws IOException
    {
        ...
        for (SPacketPlayerListItem.AddPlayerData s38packetplayerlistitem$addplayerdata : this.players)
        {
            switch (this.action)
            {
                case ADD_PLAYER:
