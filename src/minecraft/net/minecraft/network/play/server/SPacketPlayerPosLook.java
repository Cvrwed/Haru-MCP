...
public class SPacketPlayerPosLook implements Packet<INetHandlerPlayClient>
{
    ...
    public SPacketPlayerPosLook(double xIn, double yIn, double zIn, float yawIn, float pitchIn, Set<SPacketPlayerPosLook.EnumFlags> p_i45993_9_)
    {
        this.x = xIn;
        this.y = yIn;
        this.z = zIn;
    ...
    public void readPacketData(PacketBuffer buf) throws IOException
    {
        ...
        this.field_179835_f = SPacketPlayerPosLook.EnumFlags.func_180053_a(buf.readUnsignedByte());
    }
    ...
    public void writePacketData(PacketBuffer buf) throws IOException
    {
        ...
        buf.writeByte(SPacketPlayerPosLook.EnumFlags.func_180056_a(this.field_179835_f));
    }
    ...
    public static enum EnumFlags
    {
        ...
        public static Set<SPacketPlayerPosLook.EnumFlags> func_180053_a(int p_180053_0_)
        {
            Set<SPacketPlayerPosLook.EnumFlags> set = EnumSet.<SPacketPlayerPosLook.EnumFlags>noneOf(SPacketPlayerPosLook.EnumFlags.class);

            for (SPacketPlayerPosLook.EnumFlags s08packetplayerposlook$enumflags : values())
            {
        ...
        public static int func_180056_a(Set<SPacketPlayerPosLook.EnumFlags> p_180056_0_)
        {
            int i = 0;

            for (SPacketPlayerPosLook.EnumFlags s08packetplayerposlook$enumflags : p_180056_0_)
            {
