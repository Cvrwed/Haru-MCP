...
public class SPacketMapChunkBulk implements Packet<INetHandlerPlayClient>
{
    ...
    public SPacketMapChunkBulk(List<Chunk> chunks)
    {
        ...
        for (int j = 0; j < i; ++j)
        {
            ...
            SPacketChunkData.Extracted s21packetchunkdata$extracted = SPacketChunkData.func_179756_a(chunk, true, this.isOverworld, 65535);
    ...
    public void readPacketData(PacketBuffer buf) throws IOException
    {
        ...
        for (int j = 0; j < i; ++j)
        {
            ...
            this.chunksData[j].data = new byte[SPacketChunkData.func_180737_a(Integer.bitCount(this.chunksData[j].dataSize), this.isOverworld, true)];
        }
