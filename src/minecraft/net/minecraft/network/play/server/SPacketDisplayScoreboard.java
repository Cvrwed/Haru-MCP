...
public class SPacketDisplayScoreboard implements Packet<INetHandlerPlayClient>
{
    private int position;
    private String scoreName;

    public SPacketDisplayScoreboard()
    {
    }

    public SPacketDisplayScoreboard(int positionIn, ScoreObjective scoreIn)
    {
