...
public class CPacketPlayer implements Packet<INetHandlerPlayServer>
{
    ...
    public CPacketPlayer(boolean isOnGround)
    {
    ...
    public static class CPacketPlayerPosition extends CPacketPlayer
    {
    ...
    public static class CPacketPlayerLook extends CPacketPlayer
    {
    ...
    public static class CPacketPlayerPosLook extends CPacketPlayer
    {
