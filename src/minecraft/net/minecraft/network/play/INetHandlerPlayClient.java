...
public interface INetHandlerPlayClient extends INetHandler {
	 ...
	 */
	void handleDisconnect(SPacketClientDisconnect packetIn);
	 ...
	 */
	void handleDisplayScoreboard(SPacketDisplayScoreboard packetIn);
	...
	void handleSetCompressionLevel(SPacketSetCompressionLevel packetIn);
	...
	void handleEntityNBT(SPacketUpdateEntityNBT packetIn);
}
